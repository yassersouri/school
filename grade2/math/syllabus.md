...
## Term 1 — Number Sense to 100 & Place Value Foundations (September – November)

### 1. Counting and Number Sequences
- Count forward and backward by 1s from any number to at least 100.
- Skip count by 2s, 5s, 10s, and 25s using concrete materials, number lines, and charts.
- Count by 3s and 4s in playful patterning contexts. **(needs exercises)**
- Identify missing numbers in counting sequences.

### 2. Reading, Writing, and Representing Numbers to 100
- Read and write numerals to 100 and begin extending to 200 and 1,000 through chart work. **(needs exercises)**
- Read and write number words for common two-digit numbers; connect math vocabulary to [Reading Syllabus — Thematic Word Sets](../reading/syllabus.md#5-thematic-word-sets--expanded-categories).
- Represent numbers using ten frames, base-10 blocks, tally marks, number lines, and place-value charts.

📂 **Repo materials:** [Place Value to 100 — index](01_place_value_to_100/index.html) — [Tens and Ones Builders](01_place_value_to_100/01_tens_ones_builders.html), [Expanded Form and Number Words](01_place_value_to_100/02_expanded_form_number_words.html).

### 3. Place Value to 100
- Understand two-digit numbers as tens and ones.
- Compose and decompose numbers in more than one way (e.g. 36 = 3 tens 6 ones, and 2 tens 16 ones). **(needs exercises)**
- Use expanded form (47 = 40 + 7).
- Explain why the digit in the tens place means groups of ten.

📂 **Repo materials:** [Tens and Ones Builders](01_place_value_to_100/01_tens_ones_builders.html), [Expanded Form and Number Words](01_place_value_to_100/02_expanded_form_number_words.html).

### 4. Comparing and Ordering Numbers
- Compare two-digit numbers using tens first, then ones.
- Use `<`, `>`, and `=` correctly.
- Order sets of numbers from least to greatest and greatest to least.
- Find 10 more, 10 less, 1 more, and 1 less.
...
## Term 2 — Addition and Subtraction Strategies to 100 (December – February)

### 1. Mental Math Strategies
- Use doubles, near doubles, make-10, count on, count back, and compensation strategies.
- Add and subtract multiples of 10 mentally.
- Explain strategy choices aloud or in pictures. **(needs exercises)**

### 2. Two-Digit Addition Without and With Regrouping
- Add a one-digit number to a two-digit number.
- Add two-digit numbers without regrouping.
- Add two-digit numbers with regrouping, using base-10 blocks, place-value charts, and vertical form.
- Understand that 10 ones can be regrouped as 1 ten.

📂 **Repo materials:** [Two-Digit Addition With Regrouping](02_addition_subtraction_regrouping_100/01_addition_with_regrouping.html).

### 3. Two-Digit Subtraction Without and With Regrouping
- Subtract one-digit and two-digit numbers from two-digit numbers.
- Use place-value reasoning to borrow/regroup a ten into 10 ones.
- Connect subtraction with missing-addend thinking.

📂 **Repo materials:** [Two-Digit Subtraction With Regrouping](02_addition_subtraction_regrouping_100/02_subtraction_with_regrouping.html).

### 4. Relationship Between Addition and Subtraction
- Use inverse operations to check answers.
- Write fact families with related numbers.
- Decide whether equations are true or false. **(needs exercises)**

📂 **Repo materials:** [Regrouping Word Problems](02_addition_subtraction_regrouping_100/03_regrouping_word_problems.html).

### 5. Word Problems and Math Communication
- Solve one-step and simple two-step addition and subtraction word problems within 100.
- Show thinking with pictures, equations, number sentences, and words.
- Choose a sensible operation from story clues.
...
- Model groups of 2, 5, and 10 using real objects and drawings.
...
- Explain that equal shares of the same whole must be the same size.
...
- Read graphs to compare categories and totals.
...
**Number Sense**
- Count, read, write, compare, and order numbers to at least 100, with growing confidence toward 1,000.
- Represent two-digit numbers in multiple ways using tens and ones.
- Use number words, expanded form, and place-value language accurately.
