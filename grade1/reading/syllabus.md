...
- *Creative reading strand (sheets 6–13):* [The Treasure Map 🗺️](17_sound_it_out/06_treasure_map.html) (illustrated parchment map with 10 chunked place names + a quest story trail), [The Sound-It-Out Café 🍽️](17_sound_it_out/07_sound_it_out_cafe.html) (roleplay restaurant menu with chunked dish names and sample customer orders), [Tongue Twister Speed Lab 🌀](17_sound_it_out/08_tongue_twister_lab.html) (8 alliterative tongue twisters with 🐌 Slow → 🚶 Medium → 🏃 Fast star-tracked reading rounds for fluency), [Pick-Your-Path Reader 🧭](17_sound_it_out/09_choose_your_adventure.html) (branching adventure story — child picks the path and reads to one of four endings), [Comic Strip Reader 💬](17_sound_it_out/10_comic_strip.html) (6-panel comic with speech bubbles full of chunked words + bonus panels), [Trading Card Pack 🃏](17_sound_it_out/11_trading_cards.html) (6 themed character cards with chunked names, stats, HP and special moves + a battle script), [I Spy Picture Hunt 🔍](17_sound_it_out/12_i_spy.html) (big illustrated park scene with hidden items found by reading chunked clues + tiny bug hunt + silly trap clues), [Word Maze: Real or Silly? 🧩](17_sound_it_out/13_word_maze.html) (5×5 maze — step only on REAL chunked words from ⭐ to 🏁 — plus a word ladder and silly-word giggle list).
...
- `17_sound_it_out/` — explicit decoding strategy applied to new but decodable words (CVC, blends, digraphs, multi-syllable chunking) plus creative reading-in-context sheets (treasure map, café menu, tongue twisters, pick-your-path adventure, comic strip, trading cards, I Spy hunt, real-vs-silly word maze)
